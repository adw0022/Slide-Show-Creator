...
public class SlideLeftAnimation implements Animation {
  ...
  public boolean needToStartThread = false;
      ...
      SpecialPanel(SlideLeftAnimation owner,BufferedImage firstImage, BufferedImage secondImage){
          this.owner = owner;
      ...
      SpecialPanel(SlideLeftAnimation owner,Component component1, Component component2){
          this.owner = owner;
