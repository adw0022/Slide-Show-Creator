...
public class SlideRightAnimation implements Animation {
  ...
  public boolean needToStartThread = false;
      ...
      SpecialPanel(SlideRightAnimation owner,BufferedImage firstImage, BufferedImage secondImage){
          this.owner = owner;
      ...
      SpecialPanel(SlideRightAnimation owner,Component component1, Component component2){
          this.owner = owner;
      ...
      public synchronized void paint(Graphics g){
          ...
          int hh = firstImage.getHeight();
          {
              ...
              g2d.drawImage(secondImage,null,ix * (w - offset),0);
