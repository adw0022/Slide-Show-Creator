 ...
 * @author lasko_000
 */
public class SlideUpAnimation implements Animation {
  ...
  public boolean needToStartThread = false;
      ...
      SpecialPanel(SlideUpAnimation owner,BufferedImage firstImage, BufferedImage secondImage){
          this.owner = owner;
      ...
      SpecialPanel(SlideUpAnimation owner,Component component1, Component component2){
          this.owner = owner;
